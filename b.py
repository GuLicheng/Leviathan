...
def main_func(argv):
    images = ImageHandle.files(r"G:\DataSet\SBUshadow\SBUTrain\ShadowImages")
    global  imgOri
    imgOri = cv.imread(r"G:\DataSet\SBUshadow\SBUTestRename\ShadowImages\MY63.jpg")
    splitRGBTest(imgOri)
...
if __name__ == '__main__':
    ...
    for img in images:
        name = "G:/DataSet/SBUshadow/SBUTestRename/ShadowHSV/" + img.replace('\\', '/').split('/')[-1]
        RGB = cv.imread(img)
