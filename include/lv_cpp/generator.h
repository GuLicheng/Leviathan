...
public:
    ...
    public:
        ...
        pointer operator->() const noexcept requires std::is_reference_v<reference> {
...
constexpr inline bool std::ranges::enable_view<MYGENERATOR::generator<T, U>> = true;
