...
b = { a = [
        ...
        auto ba = AutomaticSearchTableOrArray(root, "b", "a");
        REQUIRE(ExtractTomlArrayElementAndCompare<toml::integer>(*ba, {0}, 1));
        REQUIRE(ExtractTomlArrayElementAndCompare<toml::integer>(*ba, {1}, 2));
        
        auto bb = AutomaticSearchTableOrArray(root, "b", "b");
        REQUIRE(ExtractTomlArrayElementAndCompare<toml::integer>(*bb, {0}, 3)); 
        REQUIRE(ExtractTomlArrayElementAndCompare<toml::integer>(*bb, {1}, 4)); 
    }
}
...
// Maybe we can directly use https://github.com/toml-lang/toml-test/tree/master/tests
